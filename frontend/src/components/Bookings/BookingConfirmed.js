import {useParams, useHistory} from 'react-route-dom'
    ...
    <div className='booking-confirmed-outer-container'>
        <div className='booking-confirmed-container'>
            <div className='booking-confirmed-inner-container'>
                    ...
                    <div className='booking-confirmed-checkin-checkout-container'>
                        <div className='booking-confirmed-check-container'>
                            <div className='booking-confirmed-checkin-container'>
                                <div className='booking-confirmed-check-in'>Check-in</div>
                                <div className='booking-confirmed-check-in-date'>{`${weekday(startInt)}, ${currentBooked?.startDate}`}</div>
                                <div className='booking-confirmed-check-in-time'>3:00PM</div>
                            </div>
                ...
                <div className='booking-confirmed-details-container'>
                    <div className='booking-confirmed-reservation-details-container'>
                        ...
                        <div className='booking-confirmed-cancel' onClick={() => handleDelete(bookingId)}></div>
            ...
            <div className='booking-confirmed-divider'>
                <div className='booking-confirmed-staying-container'>Where you're staying</div>
                <div className='booking-confirmed-house-rules'>House Rules</div>
                <div className='booking-confirmed-house-rules-info'>No smoking, no drugs, no parties allowed. Do not disturb your neighbors.
                Do not break anything. If there are any issues, please reach out to me directly. </div>
            </div>
            ...
            <div className='booking-confirmed-payment-info-container'>
                ...
                <div className='booking-confirmed-payment-info'>Payment details</div>
